...
public class FriendRequestControllerTest {
    ...
    public void setUp() {
        ...
        User user2 = new User("user2", "password2", "user2@test.com", "UserTwo", 0L, "active");
        ...
        tokenUser2 = "Bearer " + jwtUtil.createAccessToken(new CustomUserInfoDto(userId2, "user2", "password2", "user2@test.com", "UserTwo", "ROLE_USER"));
    }
